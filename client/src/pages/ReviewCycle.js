  ...
  return (
    <div className="content">
      <center><h1>Review Cycle</h1> 
        ...
        <table>
            <tr><th>Sr. No.</th><th>Review Cycle Name</th><th>Start Date</th><th>End Date</th></tr>
            {
            reviewDetails.map((val) => {
                return <tr><td>{val.Review_Id}</td><td>{val.Review_Cycle_Name}</td><td>{val.Start}</td><td>{val.End}</td></tr>              
            })}
        </table>
              </center><br/>
    </div>
